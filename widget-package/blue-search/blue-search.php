...
function bsrch_register_assets() {
    ...
    wp_add_inline_style(
        'blue-search-styles',
        'blue-search-embed,blue-search-launcher{display:block;background:transparent!important;}blue-search-launcher{display:block;position:relative;z-index:2147483647;}'
    );
...
function bsrch_normalize_asset_url($val) {
    ...
    if (preg_match('~^(img/|assets/)~i', $val)) {
        return esc_url($base . ltrim($val, '/'));
    }
